...
async function getData(category: string) {
  const query = `*[_type == "project" && category->name == "${category}"] | order(_createdAt desc) {
        _id,
