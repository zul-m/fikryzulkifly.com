...
const HeroSection = () => {
  ...
  return (
    <section id="home" className="pt-24 pb-0 lg:pt-32 lg:pb-10" ref={ref}>
          ...
          <div className="lg:w-4/12 z-[3] relative font-poppins font-bold">
            ...
            {heroContent.intro.title && (
              <motion.h1
                ...
                viewport={{ once: true }}
                className="w-auto max-w-xl mb-4 text-3xl text-gray-800 sm:text-4xl md:text-5xl lg:text-6xl lg:w-screen md:mb-8"
              >
                {heroContent.intro.title}
              </motion.h1>
            )}
            {heroContent.intro.description && (
              <motion.p
                ...
                viewport={{ once: true }}
                className="w-auto max-w-xl mb-5 text-base leading-relaxed tracking-wide text-gray-500 lg:w-screen lg:text-lg lg:mb-16"
              >
                {heroContent.intro.description}
              </motion.p>
            )}
